...
public class DocumentoTest {
	...
	public void inicializaDocumento(){
		...
		Cabecalho cabecalho = new Cabecalho( null, ultimaAlteracao, usuario);
		Introducao introducao = new Introducao(null, ultimaAlteracao);
		introducao.escreverIntroducao("INTRODUCAO DE TESTE");
		this.documento = new Documento(cabecalho, introducao, null );
	}
	...
	public void testAdicionaParteDocumento() {
		...
		camposCorpo.add(new Campo("Fluxo Principal","Coloque aqui o fluxo principal do caso de uso", TipoCampo.caixaTextoGrande));
		Corpo corpo = new Corpo( null, 
								 new UltimaAlteracao( new Usuario("Usuario", "senhausuario") , 
																new Date()) , camposCorpo);
